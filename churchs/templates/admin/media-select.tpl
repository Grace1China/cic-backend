...
<div> {{ label }} </div>
<media-sele ref="{{ name }}" name="{{ name }}" value="{{ value }}" :ro="ro" @click="popupCenter('/media_browse/?type=images&from={{ name }}','媒体库',900,600)"  @clickp="preview" @clickd="ro=undefined"></media-sele>
